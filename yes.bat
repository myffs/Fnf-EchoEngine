...
title Echo Engine
echo Before continuing, verify if you have the latest version of Haxe if not install it.
echo https://haxe.org/download/
echo Press any key to install the following libraries
pause >nul
title Echo Engine - Installing libraries
...
title Echo Engine - User action required
cls
...
:SkipVSCommunity
cls
title Echo Engine - Ready
echo Setup ready. Press any key to exit.
pause >nul
exit

:InstallVSCommunity
title Echo Engine Setup - Installing Visual Studio Community
