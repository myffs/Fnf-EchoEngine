...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["The Actual Funkin' Time",	"Play on a friday night.",						'friday_night_play',	 true],
		["Zaddy...",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Tricking? or Cheating?",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
