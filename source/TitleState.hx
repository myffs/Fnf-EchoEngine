...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeys:Array<String> = [
		'SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'MYFNF'
	];
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/LilDrippyMyFnf/Fnf-EchoEngine/main/gitVersion.txt");

			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.echoEngineVersion.trim();
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			case 'MYFNF':
				gfDance.frames = Paths.getSparrowAtlas('MyfnfBump');
				gfDance.animation.addByPrefix('danceLeft', 'myfnf Title Bump', 24, false);
				gfDance.animation.addByPrefix('danceRight', 'myfnf Title Bump', 24, false);
			#end
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if ECHO_WATERMARKS
					createCoolText(['Echo Engine by'], 15);
					#else
